...
<html>
	<head>
		...
		<title>Rekap Data Pelanggan - RepeatOrder - holasweater.id</title>
	...
	<body>
		...
		<div class="main">
			<table id="tabel1" class="table table-striped table-hover" border="1" cellpadding="0" cellspacing="1">
				...
				<?php 
					...
					$data = mysqli_query($koneksi,"select * from ro_data_pelanggan order by ID DESC");
						while($d = mysqli_fetch_array($data)){
							...
							$phone = $d['PHONE'];
							$oleh = $d['OLEH'];
							$jum_trx = $d['JUMLAH_TRX'];
								
							?>
				<tr align="center">
					<td><?php echo $no++; ?></td>
					<td align="center"><?php echo $phone; ?></td>
					<td align="center"><?php echo $jum_trx; ?></td>
					<td align="center"><?php echo $semua; ?></td>
					<td>			
						<a href='lihat-data-pelanggan?phone=<?php echo $phone; ?>' title="Lihat Detail Data Pelanggan">
						<img src="img/show.png" class="img-responsive" height="100%"></a> 
					</td>
				</tr>
				<?php 
					}
				...
				<tr>		
					<td>
						<a href="menu-utama" style="color:#6bcdec"> 
							<img align="center" style="display: block; margin: auto;height:60px;" title="Kembali ke Menu Utama" src="http://holasweater.id/repeat-order/img/home_k.png" alt="Back">
							<div class="caption">
		...
		<div class="navbar_top">
			<p style="font-size:20pt;color:white"><b>REKAP DATA PELANGGAN<br></b></p>
